        ...
        <div className='relative pointer-events-none'>
            <div className='relative flex flex-col bg-white-500 p-4 pt-16 md:p-8 lg:p-16 gap-8 text-black-500 pointer-events-auto'>
                ...
                <div className='flex flex-col gap-4 pb-4 md:pb-8 lg:pb-16'>
                    ...
                    <p
                        data-en="This website contains links to external ordering platforms like JustEat.ch, UberEats, and social media platforms Instagram, Facebook, and TikTok. When you click on these links, you leave our website. Your collected data from the banh-mi-bros.ch website are not explicitly sent to mentioned third-party platforms. Data collection and processing on these external platforms is governed exclusively by the privacy policies and terms of use of the respective providers. We have no influence on their data processing practices. We recommend that you inform yourself about data protection on these external sites."
                        data-de="Diese Website enthält Links zu externen Bestellplattformen wie JustEat.ch, UberEats und Social Media Plattformen wie Instagram, FaceBook und TikTok. Wenn Sie auf diese Links klicken, verlassen Sie unsere Webseite. Ihre gesammelten Daten von der banh-mi-bros.ch Webseite werden nicht explizit an genannte Drittanbieter Plattformen (JustEat, UberEats) übermittelt. Die Datenerhebung- und Verarbeitung auf diesen externen Plattformen unterliegt ausschliesslich den Datenschutzbestimmungen und Nutzungsbedingungen der jeweiligen Anbieter. Wir haben keinen Einfluss auf deren Datenverarbeitung. Wir empfehlen Ihnen, sich über den Datenschutz auf diesen externen Seiten zu informieren."
                    />
                    <div className='flex flex-col'>
                        <a className='hover:text-bmb-orange transition-colors duration-300' href="https://www.just-eat.ch/privacy-policy" target="_blank" rel="noopener noreferrer" data-en="Privacy Policy JustEat.ch" data-de="Datenschutzerklärung JustEat.ch" />
                        <a className='hover:text-bmb-orange transition-colors duration-300' href="https://www.uber.com/legal/en/document/?name=privacy-notice" target="_blank" rel="noopener noreferrer" data-en="Privacy Policy UberEats" data-de="Datenschutzerklärung UberEats" />
                        <a className='hover:text-bmb-orange transition-colors duration-300' href="https://help.instagram.com/155833707900388" target="_blank" rel="noopener noreferrer" data-en="Privacy Policy Instagram" data-de="Datenschutzerklärung Instagram" />
                        <a className='hover:text-bmb-orange transition-colors duration-300' href="https://www.facebook.com/privacy/policy" target="_blank" rel="noopener noreferrer" data-en="Privacy Policy FaceBook" data-de="Datenschutzerklärung FaceBook" />
                        <a className='hover:text-bmb-orange transition-colors duration-300' href="https://www.tiktok.com/legal/page/eea/privacy-policy/en" target="_blank" rel="noopener noreferrer" data-en="Privacy Policy TikTok" data-de="Datenschutzerklärung TikTok" />
                    </div>
